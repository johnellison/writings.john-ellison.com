/* Custom Styles */
nav.top-bar ul.title-area li.name h1 a img {
  width: 31px;
  height: 40px;
  margin-top: 3px; }
...
footer.site-footer {
  ...
  color: #fff; }
  footer.site-footer h4, footer.site-footer h5, footer.site-footer p, footer.site-footer ul, footer.site-footer li, footer.site-footer a {
    color: #fff; }
